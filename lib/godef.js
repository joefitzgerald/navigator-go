...
class Godef {
  constructor (goconfigFunc, gogetFunc) {
    ...
    this.godefCommand = 'navigator-godef:godef'
    this.returnCommand = 'navigator-godef:godef-return'
    this.navigationStack = new NavigationStack()
    atom.commands.add('atom-workspace', 'navigator-godef:godef', () => {
      if (this.ready()) {
        this.gotoDefinitionForWordAtCursor()
      }
    })
    atom.commands.add('atom-workspace', 'navigator-godef:godef-return', () => {
